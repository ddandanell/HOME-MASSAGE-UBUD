            ...
            <div className="mt-12 pt-12 border-t">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground mb-4">
                  ...
                  accommodation, and quality oils and treatment materials. Nusa Dua home massage typically ranges from 350,000 IDR 
                  to 650,000 IDR for single treatments, with couples home massage starting around 650,000 IDR.
                </p>
                <p className="text-lg text-muted-foreground mb-4">

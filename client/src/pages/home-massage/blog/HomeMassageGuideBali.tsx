                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="text-muted-foreground">
                        Tipping is appreciated but not mandatory in Bali. For excellent service, 10-20% is customary. Many clients tip 50,000-100,000 IDR ($3-7 USD) for standard sessions. If your therapist went above and beyond—arrived early, accommodated special requests, or provided exceptional treatment—consider tipping on the higher end. Carry cash for tipping, as digital tips rarely reach therapists directly.
                      </p>
                    </CardContent>
                  </Card>
                </div>

...
export default function Testimonials() {
  ...
  return (
    <>
      ...
      <section className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 max-w-2xl mx-auto">
              ...
              <Card key={index} className="h-full">
                <CardContent className="p-4 sm:p-6 h-full flex flex-col">
                  ...
                  <div className="relative mb-3 sm:mb-4 flex-grow">
                    <Quote className="h-5 w-5 sm:h-6 sm:w-6 text-amber-200 mb-2" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Licensed Professionals</h3>
              <p className="text-xs sm:text-sm text-gray-600">All therapists are certified, experienced, and specially trained in therapeutic massage techniques.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Consistent Quality</h3>
              <p className="text-xs sm:text-sm text-gray-600">Premium oils, professional equipment, and standardized techniques ensure the same high quality every time.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <Card className="border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <Button 
                  size="lg" 
                  className="bg-emerald-200 hover:bg-emerald-300 text-gray-900 w-full sm:w-auto px-4 sm:px-6 py-3 text-sm sm:text-base"
    ...
    <SchemaMarkup 
      type="review"
      data={{
        name: "Home Massage Ubud - Client Reviews",

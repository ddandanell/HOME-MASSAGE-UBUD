...
export default function ThaiMassage() {
  const treatment = {
    ...
    metaDescription: 'Thai massage Ubud with ancient stretching & acupressure to your villa. Boost flexibility & energy flow. From 360k IDR. Expert therapists 7am-10pm daily.',

...
export default function HotStoneMassage() {
  const treatment = {
    ...
    metaDescription: 'Hot stone massage Ubud with heated volcanic stones to your villa. Deep muscle relaxation & therapeutic heat. From 420k IDR. Licensed therapists 7am-10pm.',

...
export default function UbudSouth() {
  const area = {
    ...
    metaTitle: 'Villa Massage Ubud South | Lodtunduh & Nyuh Kuning Service',
    metaDescription: 'Book villa massage in Ubud South - Lodtunduh and Nyuh Kuning. Peaceful village spa service delivered to your accommodation. 7am-10pm. ★★★★★',

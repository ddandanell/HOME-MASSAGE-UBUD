...
export default function UbudLuxuryVillas() {
  const area = {
    ...
    metaTitle: 'Luxury Villa Massage Ubud | Premium In-Villa Spa Service',
    metaDescription: 'Book luxury villa massage in Ubud. Premium spa service for high-end villas and resorts throughout Ubud. 7am-10pm. ★★★★★ Exclusive service',

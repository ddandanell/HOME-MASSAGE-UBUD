...
export default function UbudNorth() {
  const area = {
    ...
    metaTitle: 'Villa Massage Penestanan & Sayan | Ubud North In-Villa Spa',
    metaDescription: 'Book villa massage in Penestanan and Sayan Valley. Jungle villa spa service with rice field views. 7am-10pm. ★★★★★ Ubud North',

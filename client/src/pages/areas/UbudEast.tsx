...
export default function UbudEast() {
  const area = {
    ...
    metaTitle: 'Villa Massage Ubud East | Campuhan Ridge In-Villa Service',
    metaDescription: 'Book villa massage in Ubud East and Campuhan Ridge area. Professional spa service for hikers and wellness seekers. 7am-10pm. ★★★★★',
